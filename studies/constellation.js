// STUDY 6: CONSTELLATION SEGMENTS
...
function drawConstellationSegments() {
  if (!constellationPG || constellationNodes.length === 0) initConstellationSegments();
  ...
  for (let i = 0; i < constellationNodes.length; i++) {
    ...
    // Keep the main exhibition responsive if one study fails.
